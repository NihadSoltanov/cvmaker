            ...
            <div className="grid lg:grid-cols-2 gap-8">
                <div className="bg-white/60 dark:bg-black/40 backdrop-blur-xl border border-neutral-200 dark:border-neutral-800 p-8 rounded-[2rem] space-y-6 shadow-sm">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input type="text" defaultValue="John Doe" className="input-styled h-12 text-base font-medium rounded-xl bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-800" />
                        </div>
                        <div>
                            <label className="block text-sm font-bold text-neutral-700 dark:text-neutral-300 mb-2">Email</label>
                            <input type="email" defaultValue="john@example.com" disabled className="input-styled h-12 text-base font-medium rounded-xl bg-neutral-100 dark:bg-neutral-900 cursor-not-allowed border-neutral-200 dark:border-neutral-800" />
                            <p className="text-sm font-medium text-neutral-500 mt-2">Contact support to securely change your email.</p>
                        </div>
                    </div>
                    <button className="bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 font-bold h-12 px-8 rounded-xl w-full sm:w-auto hover:opacity-90 active:scale-95 transition-all mt-4">Save Changes</button>
                </div>
                ...
                <div className="bg-white/60 dark:bg-black/40 backdrop-blur-xl border border-neutral-200 dark:border-neutral-800 p-8 rounded-[2rem] space-y-6 shadow-sm">
                    ...
                    <div className="p-6 rounded-2xl bg-indigo-50/80 dark:bg-indigo-900/10 border border-indigo-200 dark:border-indigo-800/50">
                        <h3 className="font-bold text-indigo-700 dark:text-indigo-400 text-lg flex justify-between items-center">
                            Free Plan
                            <span className="px-3 py-1 bg-indigo-100 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300 text-xs uppercase tracking-wider rounded-md font-bold">Active</span>
                        </h3>
                    ...
                    <div className="pt-6 mt-6 border-t border-neutral-200 dark:border-neutral-800/80">
                        ...
                        <button className="text-red-600 dark:text-red-400 font-bold hover:underline transition-all">Delete all my data</button>
                    </div>
                </div>
            </div>
        </div>
