    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="glass-card w-full max-w-md p-8 rounded-3xl z-10">
                ...
                <p className="text-neutral-500 text-sm mb-8">{t("loginSubtitle")}</p>
                ...
                <div className="relative my-6">
                    ...
                    <div className="relative flex justify-center text-xs"><span className="px-3 bg-white dark:bg-neutral-950 text-neutral-400 font-medium">{t("orContinueWith")}</span></div>
                </div>

                <button onClick={handleGoogleAuth}
                    className="w-full flex items-center justify-center gap-3 rounded-2xl border border-neutral-200 dark:border-neutral-800 px-4 py-3 text-sm font-semibold hover:bg-neutral-50 dark:hover:bg-neutral-900 transition">
                ...
                <p className="mt-8 text-center text-sm text-neutral-500">
                    {t("noAccount")} <Link href="/signup" className="text-indigo-600 hover:underline font-semibold">{t("signUpLink")}</Link>
                </p>
            </div>
        </div>
    );
