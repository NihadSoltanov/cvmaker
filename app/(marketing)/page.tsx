    ...
    const features = [
        {
            ...
            desc: "Generate clean, optimized PDF resumes that pass strict AI and ATS filters without losing your truthful experience."
        },
        {
        ...
        },
        {
            ...
            title: "Full App Pack",
            desc: "Not just a CV. Get customized cover letters, email text, and 3 variants of LinkedIn messages instantly."
        }
    ];
    ...
    return (
        <div className="min-h-screen relative flex flex-col antialiased bg-white dark:bg-black font-sans selection:bg-indigo-500/30">
            ...
            <main className="flex-1 flex flex-col items-center justify-center px-4 z-10 text-center relative py-24 sm:py-32">
                ...
                >
                    Land your dream <br className="hidden md:block" /> job with a <AnimatedGradientText>tailored CV</AnimatedGradientText>
                </motion.h1>
                ...
                >
                    <p className="text-sm font-bold uppercase tracking-widest text-neutral-400 mb-8">Generated applications include</p>
                    <div className="flex flex-wrap justify-center gap-8 px-4">
                        {['Master JSON Parse', 'ATS Match Score', 'Cover Letters', 'Email Subject & Body', 'Recruiter Outreach DM'].map((tag, i) => (
