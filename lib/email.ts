...
export async function sendWelcomeEmail(toEmail: string) {
    try {
        const data = await resend.emails.send({
            from: 'CViq <onboarding@resend.dev>',
            to: [toEmail],
            subject: 'Welcome to CViq!',
            html: `
        <div style="font-family: sans-serif; text-align: center; max-w-md; margin: auto; padding: 20px;">
          ...
          <p>You have successfully joined <strong>CViq</strong> — your AI-powered career intelligence platform.</p>
